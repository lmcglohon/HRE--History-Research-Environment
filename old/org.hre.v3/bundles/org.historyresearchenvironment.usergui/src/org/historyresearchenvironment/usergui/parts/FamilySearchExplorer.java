...
public class FamilySearchExplorer extends AbstractHREGuiPart {
	...
	public void createControls(Composite parent) {
		...
		tableViewerFSSearch = new TableViewer(parent, SWT.BORDER | SWT.FULL_SELECTION);

		final TableViewerColumn tableViewerColumn = new TableViewerColumn(tableViewerFSSearch, SWT.NONE);
		...
		final TableViewerColumn tableViewerColumn_5 = new TableViewerColumn(tableViewerFSSearch, SWT.NONE);
		...
		final TableViewerColumn tableViewerColumn_1 = new TableViewerColumn(tableViewerFSSearch, SWT.NONE);
		...
		final TableViewerColumn tableViewerColumn_2 = new TableViewerColumn(tableViewerFSSearch, SWT.NONE);
		...
		final TableViewerColumn tableViewerColumn_3 = new TableViewerColumn(tableViewerFSSearch, SWT.NONE);
		...
		final TableViewerColumn tableViewerColumn_4 = new TableViewerColumn(tableViewerFSSearch, SWT.NONE);
		...
		tableFSSearch.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
		tableFSSearch.setLinesVisible(true);
		tableFSSearch.setHeaderVisible(true);
		tableFSSearch.setFont(getHreFont(parent));

		tableViewerFSSearch.setContentProvider(ArrayContentProvider.getInstance());
	...
	private void subscribeNameUpdateTopic(@UIEventTopic(HreEventConstants.NAME_UPDATE_TOPIC) String perName) {
		...
		if ((tableFSSearch != null) && (tableViewerFSSearch != null) && (tableFSSearch.isVisible())) {
			updateGui();
		} else {
