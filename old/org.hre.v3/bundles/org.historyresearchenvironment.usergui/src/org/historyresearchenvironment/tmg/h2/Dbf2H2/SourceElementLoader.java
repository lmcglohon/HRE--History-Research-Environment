...
public class SourceElementLoader {
	...
	private static final String INSERT = "(RECNO, DSID, ELEMENT, GROUPNUM, TT) " + "VALUES (?, ?, ?, ?, ?)";
	 ...
	 * @param project
	 */
	public SourceElementLoader(String dbName, String project, IProgressMonitor monitor) {
		super();
		this.dbName = dbName;
