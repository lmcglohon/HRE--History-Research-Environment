...
public class NamePartTypeLoader {
	...
	private static final String INSERT = " (TEMPLATE, ID, XVALUE, SYSTEM, TYPE, " + "SHORTVALUE, TT, DSID) "
			+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
	 ...
	 * @param project2
	 */
	public NamePartTypeLoader(String dbName, String project, IProgressMonitor monitor) {
		super();
		this.dbName = dbName;
