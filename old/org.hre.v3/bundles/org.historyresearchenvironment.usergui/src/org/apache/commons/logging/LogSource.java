...
/**
 * Factory for creating {@link Log} instances. Applications should call the
 * <code>makeNewLogInstance()</code> method to instantiate new instances of the
 * configured {@link Log} implementation class.
 * <p>
 ...
 * <code>org.apache.commons.logging.Log</code> implementation class you want to
 * use.</li>
 * <li>At runtime, call <code>LogSource.setLogImplementation()</code>.</li>
 * </ul>
 *
 * @deprecated Use {@link LogFactory} instead - The default factory
 *             implementation performs exactly the same algorithm as this class
 *             did
 *
...
public class LogSource {
	...
	static protected Hashtable<String, Log> logs = new Hashtable<String, Log>();
	 ...
	 * <p>
	 * The specific {@link Log} implementation returned is determined by the value
	 * of the <tt>org.apache.commons.logging.log</tt> property. The value of
	 * <tt>org.apache.commons.logging.log</tt> may be set to the fully specified
	 ...
	 * <p>
	 * When <tt>org.apache.commons.logging.log</tt> is not set, or when no
	 * corresponding class can be found, this method will return a Log4JLogger if
	 * the log4j Logger class is available in the {@link LogSource}'s classpath, or
	 * a Jdk14Logger if we are on a JDK 1.4 or later system, or NoOpLog if neither
	...
	/**
	 * Set the log implementation/log implementation factory by class. The given
	 * class must implement {@link Log}, and provide a constructor that takes a
	 * single {@link String} argument (containing the name of the log).
	 */
	...
	/**
	 * Set the log implementation/log implementation factory by the name of the
	 * class. The given class must implement {@link Log}, and provide a constructor
