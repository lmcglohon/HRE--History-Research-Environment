 ...
 * that wraps the standard JDK logging mechanisms that are available in
 * SourceForge's Lumberjack for JDKs prior to 1.4.
 *
...
public class Jdk13LumberjackLogger implements Log, Serializable {
	...
	/**
	 * This member variable simply ensures that any attempt to initialise this class
	 * in a pre-1.4 JVM will result in an ExceptionInInitializerError. It must not
	 * be private, as an optimising compiler could detect that it is not used and
	 * optimise it away.
	 */
	...
	/**
	 * Gets the class and method by looking at the stack trace for the first entry
