...
public class NumField extends Field {
	 ...
	 * @param inDecPosition
	 *            the number of decimal positions range from 2 to 17 bytes. Relative
	 *            to Length.
	...
	public Object clone() throws CloneNotSupportedException {
		final NumField tField = (NumField) super.clone();
	...
	public String get() {
		...
		final int decoffset = Length - decPosition - 1;
	...
	public void put(double inValue) throws xBaseJException {
		final StringBuffer sb = new StringBuffer(getLength() + 1);
		sb.append("#");
		...
		final String s = df.format(inValue).trim();
		put(s);
	}
	...
	public void put(String inValue) throws xBaseJException {
		...
		final char intForm[] = new char[worklen];
		final int breaklen = decPosition == 0 ? worklen : worklen - 1; // if there is
																		// a decimal
																		// then
																		// leave
																		// room for
		...
		final char decForm[] = new char[worklen];
