...
public class IntegerField extends Field {
	...
	public IntegerField(String iName, ByteBuffer buffer) throws xBaseJException, IOException {
		super();
		super.setField(iName, 4, buffer);
	}

	/**
	 * public method for creating a IntegerField object. It is not associated with a
	 ...
	 *
	 */
	public IntegerField(String iName, int iLength) throws xBaseJException, IOException {
		super();
		super.setField(iName, iLength, null);
	}

	public IntegerField(String iName, int iLength, ByteBuffer inBuffer) throws xBaseJException, IOException {
		super();
	...
	public Object clone() throws CloneNotSupportedException {
		final IntegerField tField = (IntegerField) super.clone();
	...
	@Override
	public String get() {
		final int i = buffer[0] + (256 * (buffer[1] + (256 * (buffer[2] + (256 * (buffer[3]))))));
