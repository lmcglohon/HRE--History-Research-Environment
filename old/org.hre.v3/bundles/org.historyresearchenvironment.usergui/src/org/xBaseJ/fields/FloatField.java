...
public class FloatField extends NumField {
	...
	public void put(String inValue) throws xBaseJException {
		...
		final String workstring = inValue.substring(start, i);

		final char charray[] = new char[Length];
		...
		final int realdp = Length - decPosition;
		final String numstring = new String("0123456789");
