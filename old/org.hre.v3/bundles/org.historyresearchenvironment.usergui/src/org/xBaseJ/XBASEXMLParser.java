...
public class XBASEXMLParser extends DefaultHandler {
	...
	/**
	 * constructor, sets up SAX parser, turns off validation, turns on namespaces,
	 * sets up content handler and error handler as this object. sax exceptions go
	 * to System.err
	 */
	...
	public void error(SAXParseException e) throws SAXException {
		throw new SAXException("Error at (file " + e.getSystemId() + ", line " + e.getStackTrace()[0].getLineNumber()
	...
	public void fatalError(SAXParseException e) throws SAXException {
		throw new SAXException("Fatal Error at (file " + e.getSystemId() + ", line "
				+ e.getStackTrace()[0].getLineNumber() + ", char " + e.getColumnNumber() + "): " + e.getMessage());
	}
	 ...
	 * <li>if owned by another class, and all are except for Standard, add it to its
	 * parents object
	 * </ul>
	 * 
	 * @param uri
	...
	public void startElement(java.lang.String uri, java.lang.String localName, java.lang.String rawName,
		...
		try {
			...
			if (rawName.compareTo("dbf") == 0) {
				...
				final String dbfEncoding = attributes.getValue("encoding");
				...
				if (recordProcessing == false) {
					...
					case 'F':
						fl = Integer.parseInt(attributes.getValue("length"));
						dp = Integer.parseInt(attributes.getValue("decimalPos"));
				...
				System.err.println("Logic error: Unknown element name \"" + rawName + "\" found at element position "
						+ iElement + " line: " + iLine);
			}
		} catch (final xBaseJException xbe) {
			throw new SAXException("org.xBaseJ error: " + xbe.getMessage());
	...
	public void warning(SAXParseException e) throws SAXException {
		System.err.println("Warning at (file " + e.getSystemId() + ", line " + e.getStackTrace()[0].getLineNumber()
				+ ", char " + e.getColumnNumber() + "): " + e.getMessage());
	}
