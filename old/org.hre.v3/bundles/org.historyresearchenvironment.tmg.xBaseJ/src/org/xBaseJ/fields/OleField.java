...
public class OleField extends Field {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			OleField tField = new OleField(Name, null, null);
			return tField;
	...
	public OleField(String Name, ByteBuffer inBuffer, DBTFile indbtobj)
	...
	public OleField(String iName, boolean inFoxPro) throws xBaseJException,
			IOException {
		super();
		super.setField(iName, 10, null);
		foxPro = inFoxPro;
