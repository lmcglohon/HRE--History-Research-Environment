 ...
 */
// @Entity
// @Table(name="HDATE_DATE_TYPE_DEFNS")
// @NamedQuery(name="HdateDateTypeDefn.findAll", query="SELECT h FROM HdateDateTypeDefn h")
public class HdateDateTypeDefn implements Serializable {
	...
	// @Column(name="HDATE_DATE_TYPE_DEFN_PID", nullable=false)
