 ...
 */
// @Entity
// @Table(name="DIGITAL_NAMES")
// @NamedQuery(name="DigitalName.findAll", query="SELECT d FROM DigitalName d")
public class DigitalName implements Serializable {
	...
	// @Column(name="DIGITAL_NAME_PID", nullable=false)
