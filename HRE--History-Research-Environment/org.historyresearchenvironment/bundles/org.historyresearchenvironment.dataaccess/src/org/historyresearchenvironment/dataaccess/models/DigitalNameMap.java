 ...
 */
// @Entity
// @Table(name="DIGITAL_NAME_MAPS")
// @NamedQuery(name="DigitalNameMap.findAll", query="SELECT d FROM DigitalNameMap d")
public class DigitalNameMap implements Serializable {
	...
	// @Column(name="DIGITAL_NAME_MAP_PID", nullable=false)
