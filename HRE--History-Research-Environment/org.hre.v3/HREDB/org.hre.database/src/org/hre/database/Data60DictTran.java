...
/**
 * The persistent class for the DATA_60_DICT_TRANS database table.
 * 
 */
@Entity
@Table(name = "DATA_60_DICT_TRANS")
@NamedQuery(name = "Data60DictTran.findAll", query = "SELECT d FROM Data60DictTran d")
public class Data60DictTran extends AbstractHreTableRow implements Serializable {
	private static final long serialVersionUID = 1L;

	@Column(name = "COMMIT_PID")
	private int commitPid;

	@Column(name = "DATA_60_DICT_TRAN_PID")
	private int data60DictTranPid;
	...
	public int getData60DictTranPid() {
		return this.data60DictTranPid;
	}
	...
	public void setData60DictTranPid(int data60DictTranPid) {
		this.data60DictTranPid = data60DictTranPid;
	}
