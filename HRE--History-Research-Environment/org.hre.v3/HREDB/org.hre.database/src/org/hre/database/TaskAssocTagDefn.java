...
/**
 * The persistent class for the TASK_ASSOC_TAG_DEFNS database table.
 * 
 */
@Entity
@Table(name = "TASK_ASSOC_TAG_DEFNS")
@NamedQuery(name = "TaskAssocTagDefn.findAll", query = "SELECT t FROM TaskAssocTagDefn t")
public class TaskAssocTagDefn extends AbstractHreTableRow implements Serializable {
	...
	@Column(name = "TASK_ASSOC_TAG_DEFN_PID")
	private int taskAssocTagDefnPid;
	...
	public int getTaskAssocTagDefnPid() {
		return this.taskAssocTagDefnPid;
	}
	...
	public void setTaskAssocTagDefnPid(int taskAssocTagDefnPid) {
		this.taskAssocTagDefnPid = taskAssocTagDefnPid;
	}
