...
/**
 * The persistent class for the EVENT_BTWN_ASSOC_TAG_DEFNS database table.
 * 
 */
@Entity
@Table(name = "EVENT_BTWN_ASSOC_TAG_DEFNS")
@NamedQuery(name = "EventBtwnAssocTagDefn.findAll", query = "SELECT e FROM EventBtwnAssocTagDefn e")
public class EventBtwnAssocTagDefn extends AbstractHreTableRow implements Serializable {
	...
	@Column(name = "EVENT_BTWN_ASSOC_TAG_DEFN_PID")
	private int eventBtwnAssocTagDefnPid;
	...
	public int getEventBtwnAssocTagDefnPid() {
		return this.eventBtwnAssocTagDefnPid;
	}
	...
	public void setEventBtwnAssocTagDefnPid(int eventBtwnAssocTagDefnPid) {
		this.eventBtwnAssocTagDefnPid = eventBtwnAssocTagDefnPid;
	}
