...
/**
 * The persistent class for the DATA_400_DICT_TRANS database table.
 * 
 */
@Entity
@Table(name = "DATA_400_DICT_TRANS")
@NamedQuery(name = "Data400DictTran.findAll", query = "SELECT d FROM Data400DictTran d")
public class Data400DictTran extends AbstractHreTableRow implements Serializable {
	private static final long serialVersionUID = 1L;

	@Column(name = "COMMIT_PID")
	private int commitPid;

	@Column(name = "DATA_400_DICT_TRAN_PID")
	private int data400DictTranPid;
	...
	public int getData400DictTranPid() {
		return this.data400DictTranPid;
	}
	...
	public void setData400DictTranPid(int data400DictTranPid) {
		this.data400DictTranPid = data400DictTranPid;
	}
