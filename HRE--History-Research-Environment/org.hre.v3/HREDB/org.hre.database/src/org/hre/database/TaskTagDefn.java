...
/**
 * The persistent class for the TASK_TAG_DEFNS database table.
 * 
 */
@Entity
@Table(name = "TASK_TAG_DEFNS")
@NamedQuery(name = "TaskTagDefn.findAll", query = "SELECT t FROM TaskTagDefn t")
public class TaskTagDefn extends AbstractHreTableRow implements Serializable {
	...
	@Column(name = "TASK_TAG_DEFN_PID")
	private int taskTagDefnPid;
	...
	public int getTaskTagDefnPid() {
		return this.taskTagDefnPid;
	}
	...
	public void setTaskTagDefnPid(int taskTagDefnPid) {
		this.taskTagDefnPid = taskTagDefnPid;
	}
