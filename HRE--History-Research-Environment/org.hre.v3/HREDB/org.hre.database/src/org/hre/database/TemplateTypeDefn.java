...
public class TemplateTypeDefn extends AbstractHreTableRow implements Serializable {
	...
	@Column(name = "TEMPLATE_TYPE_DEFN_PID")
	private int templateTypeDefnPid;

	@Column(name = "TEMPLATE_TYPE_DEFNS_PID")
	private int templateTypeDefnsPid;
	...
	public int getTemplateTypeDefnsPid() {
		return this.templateTypeDefnsPid;
	}
	...
	public void setTemplateTypeDefnsPid(int templateTypeDefnsPid) {
		this.templateTypeDefnsPid = templateTypeDefnsPid;
	}
