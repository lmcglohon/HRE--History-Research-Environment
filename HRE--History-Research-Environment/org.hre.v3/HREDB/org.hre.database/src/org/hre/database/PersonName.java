...
public class PersonName extends AbstractHreTableRow implements Serializable {
	...
	public int getPersonNamePid() {
		return this.personNamePid;
	}
	...
	public void setHdatePid(short hdatePid) {
	...
	public void setPersonNamePid(int personNamePid) {
