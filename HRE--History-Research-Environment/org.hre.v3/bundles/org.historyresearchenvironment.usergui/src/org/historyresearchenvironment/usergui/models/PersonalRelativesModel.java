 ...
 *
 */
public class PersonalRelativesModel extends AbstractHreModel {
	private int Id;
	 ...
	 * @param nextGen
	 */
	public PersonalRelativesModel(String identity, Vector<PersonalRelativesItem> lastGen,
	...
	public void addLastGen(String name, String relationship, String sex, String lifespan, String gen, String children) {
		PersonalRelativesItem item = new PersonalRelativesItem(name, relationship, sex, lifespan, gen, children);
		lastGen.add(item);
	}
