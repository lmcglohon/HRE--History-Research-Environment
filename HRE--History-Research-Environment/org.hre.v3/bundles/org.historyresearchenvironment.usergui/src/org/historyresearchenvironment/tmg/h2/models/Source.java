 ...
 *
 * INSERT INTO SOURCE (MACTIVE, MAJNUM, REF_ID, ABBREV, DEFSURE, TITLE, TYPE,
 * RECORDER, MEDIA, FIDELITY, INDEXED, STATUS, TEXT, SPERNO, ISPICKED, INFO,
 * FFORM, SFORM, BFORM, CITED, IBIDTYPE, SUBJECTID, COMPILER, EDITORID, SPERNO2,
 * INCITEDFLD, CUSTTYPE, FIRSTCD, DSID, REMINDERS, TT ) VALUES (?, ?, ?, ?, ?,
 * ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, )
 */
public class Source {
